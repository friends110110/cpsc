    ...
    objects: {
        ...
        navigator: {
            children: {
                ...
                pageContext: {
                	path: 'cordova/plugin/android/PageContext'
                }
            }
        },
        Acceleration: {
...
define("cordova/plugin/android/PageContext", function(require, exports, module) {
var exec = require('cordova/exec');
var utils = require('cordova/utils');
function PageContext() {
	...
	this.getParameter(function(result) {
		if(result) {
			_this.parameters = utils.clone(result);
		}
	}, "");
};
PageContext.prototype.getParameter = function(success, name) {
	var _this = this;
	...
	}, null, "PageContext", "getParameter", [{name : name}]);
};
module.exports = new PageContext();
});
